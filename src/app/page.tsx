        ...
        <section id="about" className="bg-black/60 backdrop-blur-sm py-16 px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-white/80 leading-relaxed mb-8">
              <span className="text-4xl font-[family-name:var(--font-great-vibes)]">W</span>e believe the Universe is everything—it was here before us and will be here after. 
